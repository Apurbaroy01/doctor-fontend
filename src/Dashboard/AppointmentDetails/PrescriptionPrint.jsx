...
const PrescriptionPrint = ({ appointment, formData, doctor }) => {
  ...
  <html>
    ...
    <body>
      <div class="w-[800px] mx-auto bg-white h-screen shadow-lg border border-gray-300 relative overflow-hidden">
          ...
          <div class="flex gap-8">
            ...
            <div class="flex-1">
              <div class="flex items-center mb-3">
                <span class="text-[60px] text-blue-600 font-bold mr-2 leading-none">℞</span>
        ...
        <!-- FOOTER -->
        <footer class="absolute bottom-0 left-0 w-full bg-gradient-to-r from-blue-100 to-blue-50 border-t-4 border-blue-600 p-5 text-center">
          ...
          <p class="text-xs text-gray-400 mt-1">This is a computer-generated prescription. Signature not required.</p>
        </footer>
